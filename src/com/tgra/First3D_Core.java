...
public class First3D_Core implements ApplicationListener, InputProcessor
{
	...
	private void display() {
        ...
        float[] lightPosition = {this.wiggleValue, 20.0f, 1.0f, 1.0f};
        lightPosition[0] = this.cube.x+10f;
        lightPosition[1] = this.cube.y+5f;
        lightPosition[2] = this.cube.z;
        ...
        for(int i=0;i<doges;i++) {
            Gdx.gl11.glPushMatrix();
        	Gdx.gl11.glTranslatef(this.cam.eye.x+2f, this.cam.eye.y+2f, this.cam.eye.z-2.9f+(i*1.1f));
        	this.dogebox.draw();
        	Gdx.gl11.glPopMatrix();
        }
