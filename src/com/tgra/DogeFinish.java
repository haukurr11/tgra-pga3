...
public class DogeFinish {
        ...
        public class Cube {
            ...
            public void draw()
            {
                    ...
                    Gdx.gl11.glScalef(130f, 130f, 130f);
        ...
        public DogeFinish(float x, float y, float z) {
        	this.x=x;
        	this.y=y;
        	this.z=z;
        	this.cube = new Cube("assets/textures/nottransparentdoge.png");
        }
